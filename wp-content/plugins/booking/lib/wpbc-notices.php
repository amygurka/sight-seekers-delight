...
class WPBC_Notices {
    ...
    function __construct() {
        ...
        $this->messages['updated_paid_to_free'] = '<strong>'. __('Warning!','wpdev-booking') . '</strong> ' 
    ...
    private function hooks(){
        ...
        add_action('wpbc_hook_resources_page_header',   array( $this, 'show_system_messages') );
    ...
    public function show_system_messages($my_page) {
        ...
        ?><div class="wpbc_admin_message wpbc_page_<?php echo $my_page; ?>"><?php 
...
//            $this->show_message( $this->messages['updated_paid_to_free'] , 20 );    
    ...
    function show_alert($message) {
        ...
        $alert_head = __('Note', 'wpdev-booking');
        
        $my_close_open_alert_id = 'bk_alert_settings_form_in_free';
        
        ?>
        <div  class="alert alert-block alert-info <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_alert_id ) ) echo 'closed'; ?>"                             
              id="<?php echo $my_close_open_alert_id; ?>">
            <a class="close tooltip_left" rel="tooltip" title="<?php _e("Don't show the message anymore",'wpdev-booking');?>" data-dismiss="alert" 
