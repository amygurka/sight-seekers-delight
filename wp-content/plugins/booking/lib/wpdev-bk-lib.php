...
if ( ! defined( 'ABSPATH' ) ) exit;                                             // Exit if accessed directly
    ...
    function wpdevbk_dates_selection_for_filter($wpdevbk_id,  $wpdevbk_id2,
            ...
            $filter_labels = array(
                                ...
                                __('Next', 'wpdev-booking'),
                                __('Prior', 'wpdev-booking'),
                                '',
                    ...
                    <ul class="dropdown-menu" style="display:none;" id="<?php echo $wpdevbk_id; ?>_container" >
                        ...
                        <li><div style="line-height: 2em;margin-left: 10px;"> 
                              <fieldset>
                                ...
                                <label style="padding-left: 0 !important;" for="<?php echo $wpdevbk_id; ?>days_interval1"><?php _e('Next', 'wpdev-booking'); ?>: </label>                                
                        ...
                        <li><div style="line-height: 2em;margin-left: 10px;"> 
                            <fieldset>
                               <input  <?php if ( isset($_REQUEST[ $wpdevbk_id . 'days_interval_Radios']) ) if ( $_REQUEST[ $wpdevbk_id . 'days_interval_Radios'] == 'prior' ) echo ' checked="CHECKED" ';  ?>
                                    ...
                                    style="margin:0;vertical-align: baseline;" />
                                <label style="padding-left: 0 !important;" for="<?php echo $wpdevbk_id; ?>days_interval2"><?php _e('Prior', 'wpdev-booking'); ?>: </label>
                            <div class="btn-group" style="float: right;margin-right: 10px;">  
    ...
    function wpdevbk_show_help_dropdown_menu_in_top_menu_line() {
        ...
        <span class="dropdown pull-right">
          ...
          <ul class="dropdown-menu" id="menu1" style="right:0px; left:auto;">
            ...
            <li class="divider"></li>
            <li><a style="font-size: 1.1em;font-weight: bold;" href="<?php echo wpbc_up_link(); ?>" target="_blank"><?php if ( wpbc_get_ver_sufix() == '' ) { _e('Upgrade Now', 'wpdev-booking'); } else { _e('Upgrade Now', 'wpdev-booking'); } ?></a></li>
          </ul>
        </span>
        <?php
    }
...
//debuge($booking_types);
            ...
            <div class="booking-submenu-tab-container" style="">
                <div class="nav-tabs booking-submenu-tab-insidecontainer">
                    ...
                    <div class="visibility_container active" id="filter" style="<?php if ($selected_title == 'filter') { echo 'display:block;'; } else { echo 'display:none;'; }  ?>">
                        ...
                        <span id="show_link_advanced_booking_filter" class="tab-bottom tooltip_right" data-original-title="<?php _e('Expand Advanced Filter','wpdev-booking'); ?>"  rel="tooltip"><a href="javascript:void(0)" onclick="javascript:jQuery('.advanced_booking_filter').show();jQuery('#show_link_advanced_booking_filter').hide();jQuery('#hide_link_advanced_booking_filter').show();"><i class="icon-chevron-down"></i></a></span>
                        <span id="hide_link_advanced_booking_filter" style="display:none;" class="tab-bottom tooltip_right" data-original-title="<?php _e('Collapse Advanced Filter','wpdev-booking'); ?>" rel="tooltip" ><a href="javascript:void(0)"  onclick="javascript:jQuery('.advanced_booking_filter').hide(); jQuery('#hide_link_advanced_booking_filter').hide(); jQuery('#show_link_advanced_booking_filter').show();"><i class="icon-chevron-up"></i></a></span>
                    </div>
            ...
            ?>  <div style="clear:both;height:1px;"></div>
                <div class="wpdevbk-filters-section ">
                        ...
                        <form  name="booking_filters_formID" action="" method="post" id="booking_filters_formID" class=" form-search">
                            ...
                            <button class="button button-secondary" type="submit"><?php _e('Go', 'wpdev-booking'); ?></button>
                        </form>
                        </div>
                        ...
                        <form  name="booking_filters_form" action="" method="post" id="booking_filters_form"  class="form-inline">
                            ...
                            <a class="tooltip_top button button-primary" style="float: left; "
                               data-original-title="<?php _e('Refresh booking listing', 'wpdev-booking'); ?>"  rel="tooltip" 
                                href="javascript:void(0)"
                                onclick="javascript:booking_filters_form.submit();"
                                ><?php _e('Apply', 'wpdev-booking'); ?> <i class="icon-refresh icon-white"></i></a><a 
                                data-original-title="<?php _e('Reset filter to default values', 'wpdev-booking'); ?>"  rel="tooltip" 
    ...
    <?php /**/ ?>
                            ...
                            $wpdevbk_selectors = array(__('Pending', 'wpdev-booking')   =>'0',
                                                       ...
                                                       'divider0'=>'divider',
                                                       __('Any', 'wpdev-booking')       =>'');
                            $wpdevbk_control_label =   '';
                            $wpdevbk_help_block =      __('Status', 'wpdev-booking');
                            ...
                            $wpdevbk_control_label =   '';
                            $wpdevbk_help_block =      __('Dates', 'wpdev-booking');
                            $wpdevbk_width =           'span2 wpdevbk-filters-section-calendar';
...
//                            wpdevbk_checkboxbutton_filter($wpdevbk_id, $wpdevbk_selectors, $wpdevbk_control_label, $wpdevbk_help_block);
                            ...
                            $wpdevbk_selectors = array(__('All bookings', 'wpdev-booking')   =>'',
                                                       __('New bookings', 'wpdev-booking')  =>'1',
                                                       );
                            $wpdevbk_control_label =   '';
                            $wpdevbk_help_block =      __('Show', 'wpdev-booking');
                            ...
                            $wpdevbk_control_label =   '';
                            $wpdevbk_help_block =      __('Creation', 'wpdev-booking');
                            $wpdevbk_width =           'span2 wpdevbk-filters-section-calendar';
                            $wpdevbk_icon =            '<i class="icon-calendar"></i>' ;
                            $exclude_items = array(0, 2, 4, 7, 8);
                            $default_item = 3 ;
                            ...
                            $wpdevbk_control_label =   '';
                            $wpdevbk_help_block =      __('Order by', 'wpdev-booking');
                            ...
                            <div style="float:left;display:none;" class="advanced_booking_filter btn-group">
                                ...
                                <a data-original-title="<?php _e('Save filter settings as default template (Please, click Apply filter button, before saving!)','wpdev-booking'); ?>"  rel="tooltip"
                                   class="tooltip_top button button-secondary" 
                                    ...
                                    ><?php _e('Save as Default', 'wpdev-booking'); ?> <i class="icon-download"></i></a>
                                <?php 
        ...
        function wpdev_show_booking_actions(){
                ...
                <div class="btn-toolbar">
                    <div class="btn-group">
                        <a     data-original-title="<?php _e('Approve selected bookings', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-primary"
                               onclick="javascript: 
                                                    approve_unapprove_booking( get_selected_bookings_id_in_booking_listing() ,
                                                          1, <?php echo $user_bk_id; ?>, '<?php echo getBookingLocale(); ?>' , 1);
                               " /><?php _e('Approve', 'wpdev-booking'); ?> <i class="icon-ok-circle icon-white"></i></a>
                        <a     data-original-title="<?php _e('Set selected bookings as pending', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                               onclick="javascript: 
                                            if ( bk_are_you_sure('<?php echo esc_js(__('Do you really want to set booking as pending ?', 'wpdev-booking')); ?>') )
                                                    approve_unapprove_booking( get_selected_bookings_id_in_booking_listing() ,
                    ...
                    <div class="btn-group" style="width:340px">
                        <a  data-original-title="<?php _e('Delete selected bookings', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                            onclick="javascript: 
                                    if ( bk_are_you_sure('<?php echo esc_js(__('Do you really want to delete selected booking(s) ?', 'wpdev-booking')); ?>') )
                                        delete_booking( get_selected_bookings_id_in_booking_listing() ,
                                                        <?php echo $user_bk_id; ?>, '<?php echo getBookingLocale(); ?>' , 1  );
                                    " >
                            <?php _e('Delete', 'wpdev-booking'); ?> <i class="icon-trash"></i></a>
                        <input  type="text" placeholder="<?php echo __('Reason of cancellation', 'wpdev-booking'); ?>"
                                class="span2" value="" id="denyreason" name="denyreason" />
                    </div>

                    <div class="btn-group">
                        <a     data-original-title="<?php _e('Mark as read all bookings', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                               onclick="javascript:
                                                    mark_read_booking( 'all' ,
                                                          0, <?php echo $user_bk_id; ?>, '<?php echo getBookingLocale(); ?>' );
                               " /><?php _e('Read All', 'wpdev-booking'); ?> <i class="icon-eye-close"></i></a>
                        <a     data-original-title="<?php _e('Mark as read selected bookings', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                               onclick="javascript:
                                                    mark_read_booking( get_selected_bookings_id_in_booking_listing() ,
                                                          0, <?php echo $user_bk_id; ?>, '<?php echo getBookingLocale(); ?>' );
                               " /><?php _e('Read', 'wpdev-booking'); ?> <i class="icon-eye-close"></i></a>
                        <a     data-original-title="<?php _e('Mark as Unread selected bookings', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                               onclick="javascript:                                       
                                                    mark_read_booking( get_selected_bookings_id_in_booking_listing() ,
        ...
        ?>
         <div id="listing_visible_bookings">
          ...
          <div class="row-fluid booking-listing-header">
              ...
              <div class="booking-listing-collumn span<?php echo ($is_free?'1':'2'); ?> wpbc_column_2"><?php _e('Labels', 'wpdev-booking');  if ( ! $is_free ) { echo ' / '; _e('Actions', 'wpdev-booking'); } ?></div>
              <div class="booking-listing-collumn span<?php echo ($is_free?'5':'6'); ?> wpbc_column_4"><?php _e('Booking Data', 'wpdev-booking'); ?></div>
              <div class="booking-listing-collumn span3 wpbc_column_5"><?php _e('Booking Dates', 'wpdev-booking'); ?>&nbsp;&nbsp;&nbsp;
                  <a href="javascript:void(0)" id="booking_dates_full" onclick="javascript:
                            ...
                            jQuery('.booking_dates_full').show();" data-original-title="<?php _e('Show ALL dates of booking','wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top <?php echo $short_days_class; ?> "><i class="icon-resize-full" style=" margin-top: 2px;"></i></a>
                  <a href="javascript:void(0)" id="booking_dates_small" onclick="javascript:
                            jQuery('#booking_dates_small').hide();
                            jQuery('#booking_dates_full').show();
                            jQuery('.booking_dates_small').show();
                            jQuery('.booking_dates_full').hide();" data-original-title="<?php _e('Show only check in/out dates','wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top <?php echo $wide_days_class; ?> " ><i class="icon-resize-small" style=" margin-top: 2px;"></i></a>
              </div>
              <?php if ($is_free) { ?>
              <div class="booking-listing-collumn span2 wpbc_column_5"><?php _e('Actions', 'wpdev-booking'); ?></div>
              <?php } ?>
          </div>
          <?php } else {
          ...
          ?>" >
              ...
              <div class="wpbc_column_1 booking-listing-collumn bktextcenter span1">
                    <input type="checkbox" class="booking_list_item_checkbox" 
                           ...
                           /><span class="wpbc_mobile_legend clear" style="margin:0 -5px 0 25px"><?php _e('ID', 'wpdev-booking'); ?>: </span><span class="field-id"><?php echo $booking_id; ?></span>                  
              </div>
                    ...
                    ?><a    href="javascript:void(0)"  class="tooltip_top approve_bk_link button-secondary button  <?php if ($is_approved) echo ' hidden_items '; ?> "
                       ...
                       ><i class="icon-ok-circle"></i><?php
                        /** ?><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/accept-24x24.gif" style="width:14px; height:14px;"><?php /**/ ?></a><a                     
                            ...
                            onclick="javascript:if ( bk_are_you_sure('<?php echo esc_js(__('Do you really want to set booking as pending ?', 'wpdev-booking')); ?>') ) approve_unapprove_booking(<?php echo $booking_id; ?>,0, <?php echo $user_bk_id; ?>, '<?php echo getBookingLocale(); ?>' , 1  );"
                        ...
                        /** ?><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/remove-16x16.png" style="width:15px; height:15px;"><?php /**/ ?></a><a                     
                            href="javascript:void(0)" 
                            onclick="javascript:if ( bk_are_you_sure('<?php echo esc_js(__('Do you really want to delete this booking ?', 'wpdev-booking')); ?>') ) delete_booking(<?php echo $booking_id; ?>, <?php echo $user_bk_id; ?>, '<?php echo getBookingLocale(); ?>' , 1   );"
                            data-original-title="<?php _e('Delete','wpdev-booking'); ?>"  rel="tooltip" 
                        ...
                        ?>                      
                    <div class="field-date" style="<?php echo ($is_free?'margin-top:5px;float: none;white-space: normal;':''); ?>"><span ><?php _e('Created', 'wpdev-booking'); ?>:</span> <span><?php echo $cr_date, ' ', $cr_time; ?></span></div>
                  </div>
              <?php } ?>
              </div>
         ...
         <div id="menu-wpdevplugin">
            <div class="nav-tabs-wrapper">
                <div class="nav-tabs">
                    ...
                    <?php $title = __('Actions', 'wpdev-booking'); $my_icon = 'bc-16x16.png'; $my_tab = 'actions';  $my_additinal_class= ''; ?>
    ...
    function wpdev_show_calendar_overview_interface(){
        ...
        if  ((isset($_REQUEST['wh_booking_type'])) && ( strpos($_REQUEST['wh_booking_type'], ',') !== false ) )
          ...
          ?>
            <div class="btn-toolbar">
                <div id="calendar_overview_number_of_days_to_show" class="btn-group" data-toggle="buttons-radio">
                    <a     data-original-title="<?php _e('Show month', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary btn_dn_30"
                           onclick="javascript:;"
                           href="<?php echo $bk_admin_url . '&view_days_num=30'; ?>"
                           /><?php _e('Month', 'wpdev-booking'); ?> <i class="icon-align-justify"></i></a>
                    <a     data-original-title="<?php _e('Show 3 months', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary btn_dn_90"
                           onclick="javascript:;"
                           href="<?php echo $bk_admin_url . '&view_days_num=90'; ?>"
                           /><?php _e('3 Months', 'wpdev-booking'); ?> <i class="icon-th-list"></i></a>
                    <a     data-original-title="<?php _e('Show year', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary btn_dn_365"
                           onclick="javascript:;"
          ...
          ?>
            <div class="btn-toolbar">
                <div id="calendar_overview_number_of_days_to_show" class="btn-group" data-toggle="buttons-radio">
                    <a     data-original-title="<?php _e('Show day', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary btn_dn_1"
                           onclick="javascript:;"
                           href="<?php echo $bk_admin_url . '&view_days_num=1'; ?>"
                           /><?php _e('Day', 'wpdev-booking'); ?> <i class="icon-stop"></i></a>
                    <a     data-original-title="<?php _e('Show week', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary btn_dn_7"
                           onclick="javascript:;"
                    ...
                    <a     data-original-title="<?php _e('Show 2 months', 'wpdev-booking'); ?>"  rel="tooltip" class="tooltip_top button button-secondary btn_dn_60"
                           onclick="javascript:;"
