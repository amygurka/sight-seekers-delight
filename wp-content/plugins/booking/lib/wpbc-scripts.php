...
function wpbc_define_js_vars( $where_to_load = 'both' ) {
    ...
    wp_localize_script('wpbc-global-vars', 'wpbc_global1', array(
        ...
        , 'message_verif_requred' => esc_js(__('This field is required', 'wpdev-booking'))
        , 'message_verif_requred_for_check_box' => esc_js(__('This checkbox must be checked', 'wpdev-booking'))
        , 'message_verif_requred_for_radio_box' => esc_js(__('At least one option must be selected', 'wpdev-booking'))
        , 'message_verif_emeil' => esc_js(__('Incorrect email field', 'wpdev-booking'))
        , 'message_verif_same_emeil' => esc_js(__('Your emails do not the same', 'wpdev-booking'))
        , 'message_verif_selectdts' =>  esc_js(__('Please, select booking date(s) at Calendar.', 'wpdev-booking'))
