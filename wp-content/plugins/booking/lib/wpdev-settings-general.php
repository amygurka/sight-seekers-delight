                            ...
                            <tr valign="top"> <td colspan="2">
                                ...
                                <table id="togle_settings_javascriptloading" style="display:none;" class="hided_settings_table">
                                    ...
                                    <tr valign="top" style="border-top:1px solid #ccc;">
                                        <th scope="row">
                                            <?php $show_untill_version_update = '5.5';  $wpbc_settings_element = 'dismiss_new_booking_is_load_js_css_on_specific_pages'; if ( ( version_compare(WP_BK_VERSION_NUM, $show_untill_version_update ) < 0 ) && ( '1' != get_user_option( 'booking_win_' . $wpbc_settings_element ) ) ) { ?><div id="<?php echo $wpbc_settings_element; ?>"  class="new-label clearfix-height new-label-settings"><a class="tooltip_bottom" data-original-title="<?php _e('Hide','wpdev-booking'); ?>" rel="tooltip" href="javascript:void(0)"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $wpbc_settings_element; ?>');jQuery('#<?php echo $wpbc_settings_element; ?>').hide();" ><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/label_new_blue.png" style="width:24px; height:24px;"></a></div><?php } /**/ ?> 
                                            <?php _e('Load JS and CSS files only on specific pages', 'wpdev-booking'); ?>:
                                        </th>
                                        <td>
                                            <fieldset>
                                                <label for="is_load_js_css_on_specific_pages" >
                                                    ...
                                                    onclick="javascript: if (this.checked) { var answer = confirm('<?php  _e('Warning','wpdev-booking'); echo '! '; _e("You are need to be sure what you are doing. You are disable of loading some JavaScripts Do you really want to do this?", 'wpdev-booking'); ?>'); if ( answer){ this.checked = true; jQuery('#togle_settings_load_js_css_on_specific_pages').slideDown('normal'); } else {this.checked = false; } } else { jQuery('#togle_settings_load_js_css_on_specific_pages').slideUp('normal'); }"
                                                       />
                                                    <?php _e('Activate loading of CSS and JavaScript files of plugin only at specific pages.', 'wpdev-booking'); ?>
                                                </label>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    ...
                                    <tr valign="top" style="padding: 0px;"><td colspan="2"  style="padding:0px;">                                         
                                        ...
                                        <table id="togle_settings_load_js_css_on_specific_pages" style="width:100%;<?php 
                                            ...
                                            <tr valign="top" colspan="2">
                                                <th><label for="booking_pages_for_load_js_css"><?php _e('Relative URLs of pages, where to load plugin CSS and JS files', 'wpdev-booking'); ?>:</label></th>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    ...
                                                    <p class="description"><?php printf(__('Enter relative URLs of pages, where you have Booking Calendar elements (booking forms or availability calendars). Please enter one URL per line. Example: %s', 'wpdev-booking'),'<code>/booking-form/</code>');?></p>                                                
                                                </td>
                                            </tr>
                                        </table>
