    ...
    if ( ! $is_show_resources_matrix ) {                                             // Single booking resource
        ...
        switch ($view_days_num) {
            ...
            case '365':
                $days_num = 32;
                $cell_width = '3%';
                $dwa = array(1=>__('M', 'wpdev-booking'),2=>__('Tu', 'wpdev-booking'),3=>__('W', 'wpdev-booking'),4=>__('Th', 'wpdev-booking'),5=>__('F', 'wpdev-booking'),6=>__('Sa', 'wpdev-booking'),7=>__('Su', 'wpdev-booking'));
                $time_selles_num  = 1;
                break;
            default:  // 30
                $days_num = 1;
                $cell_width =  '99%';;
                $dwa = array(1=>__('Mon', 'wpdev-booking'),2=>__('Tue', 'wpdev-booking'),3=>__('Wed', 'wpdev-booking'),4=>__('Thu', 'wpdev-booking'),5=>__('Fri', 'wpdev-booking'),6=>__('Sat', 'wpdev-booking'),7=>__('Sun', 'wpdev-booking'));
        ...
        switch ($view_days_num) {
            case '1':
                ...
                $dwa = array(1=>__('Monday', 'wpdev-booking'),2=>__('Tuesday', 'wpdev-booking'),3=>__('Wednesday', 'wpdev-booking'),4=>__('Thursday', 'wpdev-booking'),5=>__('Friday', 'wpdev-booking'),6=>__('Saturday', 'wpdev-booking'),7=>__('Sunday', 'wpdev-booking'));
                $time_selles_num  = 24;$dwa = array(1=>__('Monday', 'wpdev-booking'),2=>__('Tuesday', 'wpdev-booking'),3=>__('Wednesday', 'wpdev-booking'),4=>__('Thursday', 'wpdev-booking'),5=>__('Friday', 'wpdev-booking'),6=>__('Saturday', 'wpdev-booking'),7=>__('Sunday', 'wpdev-booking'));
                break;
            case '7':
                $days_num = 7;
            ...
            case '60':
                ...
                $dwa = array(1=>__('M', 'wpdev-booking'),2=>__('T', 'wpdev-booking'),3=>__('W', 'wpdev-booking'),4=>__('T', 'wpdev-booking'),5=>__('F', 'wpdev-booking'),6=>__('S', 'wpdev-booking'),7=>__('S', 'wpdev-booking'));
                $time_selles_num  = 1;
                break;
            case 'old_365':
                $days_num = 365;
    ...
    if ($is_show_resources_matrix) {
        ...
        switch ($view_days_num) {
            ...
            case '60':
                $days_num = 62;
                $cell_width = '1.5%';
                $dwa = array( 1 => substr(__('Mon','wpdev-booking'),0,-1), 2 => substr(__('Tue','wpdev-booking'),0,-1), 3 => substr(__('Wed','wpdev-booking'),0,-1), 4 => substr(__('Thu','wpdev-booking'),0,-1), 5 => substr(__('Fri','wpdev-booking'),0,-1), 6 => substr(__('Sat','wpdev-booking'),0,-1), 7 => substr(__('Sun','wpdev-booking'),0,-1) );
                $time_selles_num  = 1;
                break;
            default:  // 30
                $days_num = 31;
...
//debuge($bk_resources_id);
    ...
    ?><div class="bookings_overview_in_calendar_frame">
        ...
        <tr>
            <th style="width:200px;"><?php  if ($is_show_resources_matrix) { _e('Resources','wpdev-booking'); }?></th>
